...
public class CSVStreamingPipelineTest {
	...
	public void testCSVContentProcessorDoFn() {
		...
		PCollection<KV<String, List<String>>> input = pipeline.apply(Create.of(KV.of("test", sampleStringList)));
	...
	public void testCSVStreamingInitialRestriction() {
		CSVContentProcessorDoFn csv = new CSVContentProcessorDoFn(ValueProvider.StaticValueProvider.of(2));
