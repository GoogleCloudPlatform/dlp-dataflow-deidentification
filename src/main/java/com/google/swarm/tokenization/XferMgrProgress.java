...
public class XferMgrProgress {
  ...
  public static void printProgressBar(double pct) {
    ...
    System.out.format(
        "  [%s%s]", filled_bar.substring(0, amt_full), empty_bar.substring(0, bar_size - amt_full));
  }
  ...
  public static void uploadFileWithListener(
      String file_path, String bucket_name, String key_prefix, boolean pause) {
