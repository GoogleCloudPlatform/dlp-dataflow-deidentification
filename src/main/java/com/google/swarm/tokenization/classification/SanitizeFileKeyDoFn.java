...
public class SanitizeFileKeyDoFn
    extends DoFn<FileIO.ReadableFile, KV<FileKeyObject, FileIO.ReadableFile>> {
  ...
  public void processElement(ProcessContext c) {
    ...
    else c.outputWithTimestamp(KV.of(fileKey, file), Instant.ofEpochMilli(lastModified));
  }
}
