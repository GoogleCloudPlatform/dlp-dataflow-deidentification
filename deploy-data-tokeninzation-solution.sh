...
export DATA_STORAGE_BUCKET=${PROJECT_ID}-demo-data-test-7 
export TEK=$(openssl rand -base64 32)
export KEY_RING_NAME=demo-key-ring-8  
export KEY_NAME=demo-key-9
export KEK_FILE_NAME=kek.json
export PROJECT_NUMBER=$(gcloud projects list --filter=${PROJECT_ID} --format="value(PROJECT_NUMBER)") 
export SERVICE_ACCOUNT_NAME=demo-service-account
export REGION=us-central1
export BQ_DATASET_NAME=demo_dataset_test_6
